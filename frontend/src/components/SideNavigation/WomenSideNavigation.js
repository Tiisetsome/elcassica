...
const WomenSideNavigation = (props) => {
  const style = {
      ...
      <div className="side-nav-wrapper">
        <div className="shop-navs">
          ...
          <ul>
            ...
            <Link to="/women-shop/accessories" style={style}>
              <li>Accessories</li>
            </Link>
          </ul>
        </div>
        <div className="collection-navs">
          <h4>Collection</h4>
          <ul>
            <Link style={style} to="/women-shop/collection-2020">
              <li>Best of 2020</li>
            </Link>
            <Link style={style} to="/women-shop/sale-deals">
              <li>Hottest deals</li>
            </Link>
            <Link style={style} to="/women-shop/spring">
              <li>Spring</li>
            </Link>
            <Link style={style} to="/women-shop/summer">
              <li>Summer</li>
            </Link>
          </ul>
        </div>
...
export default WomenSideNavigation;
